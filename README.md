...
| 页面 | 示意图 | 说明 |
| --- | --- | --- |
| 大屏展示 | ![大屏展示页面示意](docs/images/display-wall.svg) | 展示小组成员、实时成绩、二维码入口和风采轮播。 |
| 后台管理 | ![后台管理中心示意](docs/images/admin-console.svg) | 维护小组、成员、评价人、职务与投票数据，并提供初始化工具。 |
| 手机端评价 | ![手机端投票页面示意](docs/images/mobile-evaluation.svg) | 扫码登录后进行身份验证，快捷完成赞成/反对投票。 |
